    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel_new">新建比赛</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="match_name">比赛名称</label>
                    <input type="text" class="form-control" id="match_name" placeholder="请输入比赛名称">
                </div>
                <div class="form-group">
                    <label for="match_max">最大参赛人数</label>
                    <input type="text" class="form-control" id="match_max" placeholder="请输入最大参赛人数">
                </div>
            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#submit").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/match_submit";
            var param = {
